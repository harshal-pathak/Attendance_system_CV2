...
facedetect = cv2.CascadeClassifier(r"C:\Users\HARSHAL\Downloads\haarcascade_frontalface_default.xml")
...
if 'Candidate_names.pkl' not in os.listdir(r"C:\Users\HARSHAL\Downloads"):
    # If not present, create a list with the entered name repeated 5 times
    names = [name] * 5
    # Save the list to 'names.pkl'
    with open(r"C:\Users\HARSHAL\Downloads\names.pkl", 'wb') as f:
        pickle.dump(names, f)
else:
...
if 'faces_data.pkl' not in os.listdir(r"C:\Users\HARSHAL\Downloads"):
    # If not present, save the NumPy array 'faces_data' to 'faces_data.pkl'
    with open(r"C:\Users\HARSHAL\Downloads\faces_data.pkl", 'wb') as f:
        pickle.dump(faces_data, f)
else:
    # If 'faces_data.pkl' is present, load the existing array
    with open(r"C:\Users\HARSHAL\Downloads\faces_data.pkl", 'rb') as f:
        faces = pickle.load(f)
